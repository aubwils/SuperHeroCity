...
public class UI_StatToolTip : UI_ToolTip
{
    ...
    public void ShowToolTip(bool show, RectTransform targetRect, StatType statType)
    {
        ...
        statToolTipText.text = GetStatTooltipTextByType(statType);
    }
    ...
    public string GetStatTooltipTextByType(StatType statType)
    {
        switch (statType)
        {
            ...
            case StatType.Evasion: return "Chance to completly avoid attack." + "\n Limted at 85%.";
            ...
            case StatType.ElementalDamage: return "Elemental Damage Placeholder text - combines all elements," +
            "\n highest element is applied and corresponding element status effect and full damage." +
            "\n the others contribute 50% of their damage as a bonus.";
            ...
            default: return "No tooltip avaliable for this stat.";
