...
public class EnemySmarterWandererBrain : EnemyBrain
{
    ...
    #region States
    public EnemySmarterWandererIdleState idleState { get; private set; }
    public EnemySmarterWandererMoveState moveState { get; private set; }
    public EnemySmarterWandererChaseState chaseState { get; private set; }
    public EnemySmarterWandererMeleeAttackState meleeAttackState { get; private set; }
    public EnemySmarterWandererRecoveryState recoveryState { get; private set; }
    #endregion
    ...
    {
        base.Awake();
        idleState = new EnemySmarterWandererIdleState(this, stateMachine, "IsIdle", this);
        moveState = new EnemySmarterWandererMoveState(this, stateMachine, "IsMoving", this);
        chaseState = new EnemySmarterWandererChaseState(this, stateMachine, "IsChasing", this);
        meleeAttackState = new EnemySmarterWandererMeleeAttackState(this, stateMachine, "IsAttacking", this);
        recoveryState = new EnemySmarterWandererRecoveryState(this, stateMachine, "IsIdle", this);
    }
