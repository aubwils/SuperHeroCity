...
public class EnemySmarterWandererMoveState : EnemySmarterWandererBaseState
{
   private Vector2 moveDirection;

    public EnemySmarterWandererMoveState(EnemyBrain enemyBrain, StateMachine stateMachine, string animBoolName, EnemySmarterWandererBrain specificEnemyBrain)
