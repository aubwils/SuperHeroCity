...
public class Enemy_Simple_Wanderer_MoveState : Enemy_Simple_Wanderer_BaseState
{
    private Vector2 moveDirection;

    public Enemy_Simple_Wanderer_MoveState(Enemy_Brain enemyBrain, StateMachine stateMachine, string animBoolName, Enemy_Simple_Wanderer_Brain specificEnemyBrain)
