...
public class Enemy_Smarter_Wanderer_RecoveryState : EnemyState
{
  private Enemy_Smarter_Wanderer_Brain specificEnemyBrain;

    public Enemy_Smarter_Wanderer_RecoveryState(Enemy_Brain enemyBrain, StateMachine stateMachine, string animBoolName, Enemy_Smarter_Wanderer_Brain specificEnemyBrain)
